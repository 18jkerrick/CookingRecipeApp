...
// Unit conversion factors (Record allows string index for normalized unit lookup)
const conversionFactors: { volume: Record<string, number>; weight: Record<string, number> } = {
