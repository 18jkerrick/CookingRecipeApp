...
import { NormalizedIngredient } from '../parsers/ingredient-parser';

export interface AINormalizedIngredient extends Omit<NormalizedIngredient, 'quantity'> {
  quantity: number | null; // null when range is used
